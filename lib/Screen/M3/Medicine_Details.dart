...
class M3_MedicineDetailsScreen extends StatefulWidget {
  const M3_MedicineDetailsScreen({super.key});

  @override
  State<M3_MedicineDetailsScreen> createState() => _M3_MedicineDetailsScreenState();
}

class _M3_MedicineDetailsScreenState extends State<M3_MedicineDetailsScreen> {
  @override
