...
class M4_MedicineDetailsScreen extends StatefulWidget {
  const M4_MedicineDetailsScreen({super.key});

  @override
  State<M4_MedicineDetailsScreen> createState() =>
      _M4_MedicineDetailsScreenState();
}

class _M4_MedicineDetailsScreenState extends State<M4_MedicineDetailsScreen> {
  @override
